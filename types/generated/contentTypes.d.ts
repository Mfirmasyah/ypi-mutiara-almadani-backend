...
export interface ApiBeritaBerita extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['pengumuman', 'prestasi', 'akademik', 'kegiatan']
    > &
      Schema.Attribute.Required;
...
export interface ApiEdukasiEdukasi extends Struct.CollectionTypeSchema {
  collectionName: 'edukasis';
  info: {
    description: 'Konten artikel edukasi';
    displayName: 'Edukasi';
    pluralName: 'edukasis';
    singularName: 'edukasi';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiParentingParenting extends Struct.CollectionTypeSchema {
  collectionName: 'parentings';
  info: {
    description: 'Artikel parenting dan tips pengasuhan anak';
...
export interface ApiPendaftarPendaftar extends Struct.CollectionTypeSchema {
  collectionName: 'pendaftars';
  info: {
    description: 'Data pendaftar SPMB Mutiara Al-Madani';
  ...
  attributes: {
    ...
    alamatOrtu: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 500;
      }>;
    alamatSekolah: Schema.Attribute.Text &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 500;
      }>;
    createdAt: Schema.Attribute.DateTime;
    ...
    nilaiRataRata: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    nomorPendaftaran: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 20;
      }>;
    pekerjaanAyah: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 50;
      }>;
    pekerjaanIbu: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 50;
      }>;
    ...
    tahunLulus: Schema.Attribute.Integer &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    tanggalDaftar: Schema.Attribute.DateTime & Schema.Attribute.Required;
    tanggalLahir: Schema.Attribute.Date & Schema.Attribute.Required;
    telepon: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 15;
      }>;
    teleponAyah: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 15;
      }>;
    teleponIbu: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 15;
      }>;
...
export interface ApiPrestasiPrestasi extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Tabel untuk menyimpan data prestasi siswa per jenjang';
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['akademik', 'olahraga', 'seni', 'teknologi', 'lainnya']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'lainnya'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date: Schema.Attribute.Date & Schema.Attribute.Required;
    description: Schema.Attribute.Text & Schema.Attribute.Required;
    image: Schema.Attribute.Media<'images'>;
    jenjang: Schema.Attribute.Enumeration<['tk', 'sd', 'smp']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'sd'>;
    level: Schema.Attribute.Enumeration<
      ['sekolah', 'kota', 'provinsi', 'nasional', 'internasional']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'sekolah'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiTimelineTimeline extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Timeline untuk SPMB Mutiara Al-Madani';
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::edukasi.edukasi': ApiEdukasiEdukasi;
      'api::gallery.gallery': ApiGalleryGallery;
      'api::parenting.parenting': ApiParentingParenting;
      'api::pendaftar.pendaftar': ApiPendaftarPendaftar;
